...
})(
  {
    ...
    FOZT: [
      function (require, module, exports) {
        ...
        var HOUR_DIFF = { pm25: 24, pm10: 24, so2: 24, nox: 24, o3: 8, co: 8 };
    ...
    QCct: [
      function (require, module, exports) {
        ...
        var calculateSubIndex = function calculateSubIndex() {
          ...
          var mean =
            filtered.reduce(function (acc, _ref2) {
          ...
          if (index < 0) {
            ...
            var _aqi =
              (aqiBase / pollutantBase) * (mean - pollutantBase) + aqiBase;
          ...
          var _BANDS$index$range$po = _slicedToArray(
              BANDS[index].range[pollutant],
              2
            ),
            pollutantLo = _BANDS$index$range$po[0],
            pollutantHi = _BANDS$index$range$po[1]; // this is the basically the line
        ...
        var calculateAQI = function calculateAQI(arr) {
          ...
          var subIndexes = Object.keys(pollutantArr)
            .map(function (key) {
