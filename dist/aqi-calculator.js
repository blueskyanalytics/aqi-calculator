parcelRequire =
  ...
  "dZYI" : [
    function(require, module, exports) {
      ...
      !function(n, e) {
        "object" == typeof exports && "undefined" != typeof module
            ? module.exports = e()
            : "function" == typeof t && t.amd ? t(e) : n.dayjs = e()
      }(this, function() {
        "use strict";
        var t = "millisecond", n = "second", e = "minute", r = "hour",
            i = "day", s = "week", u = "month", a = "quarter", o = "year",
            ...
            l = "en", m = {};
        m[l] = $;
        var y = function(t) { return t instanceof v }, M = function(t, n, e) {
          var r;
          if (!t)
            return l;
          if ("string" == typeof t)
          ...
          return d.parse =
            ...
            this.$d = function(t) {
              ...
              return new Date(n)
                 ...
                 d.year = function(t) { return this.$g(t, "$y", o) },
                 ...
                 d.format =
                   ...
                   var e = t || "YYYY-MM-DDTHH:mm:ssZ", r = D.z(this),
                       ...
                       a = this.$M, o = i.weekdays, h = i.months,
                       c =
                           function(t, r, i, s) {
                 ...
                 d.diff =
                   ...
                   var c, d = D.p(h), $ = g(t),
                          ...
                          m = this - $, y = D.m(this, $);
                   return y = (c = {}, c[o] = y / 12, c[u] = y, c[a] = y / 3,
        ...
        return g.prototype = v.prototype,
               g.extend = function(t, n) { return t(n, v, g), g }, g.locale = M,
               g.isDayjs = y, g.unix = function(t) { return g(1e3 * t) },
               g.en = m[l], g.Ls = m, g
      });
    },
    {}
  ...
  "QCct" : [
    function(require, module, exports) {
      function r(r) { return n(r) || e(r) || i(r) || t() }
      function t() {
        throw new TypeError(
      ...
      function a(r, t) { return c(r) || f(r, t) || i(r, t) || o() }
      function o() {
        throw new TypeError(
      ...
      var l = require("dayjs"), y = require("./utils"), d = y.BANDS,
          s = y.HOUR_DIFF, m = function() {
            ...
            if (!Object.keys(s).includes(t))
              return 0;
            var e = l(), n = s[t], o = r.filter(function(r) {
              var t = r.datetime;
              return r.value && e.diff(l(t), "hours") < n
            });
            if (o.length <= 0)
              return 0;
            var i = o.reduce(function(r, t) { return r + t.value }, 0) /
                    o.length,
                u = d.findIndex(function(r) { return r.range[t][1] >= i });
            if (u <= 0) {
              var f = d.length - 1, c = d[f].range.aqi[1], y = d[f].range[t][1];
              return c / y * (i - y) + c
            }
            var m = a(d[u].range.aqi, 2), v = m[0], b = m[1],
                h = a(d[u].range[t], 2), p = h[0];
            ...
            var e = t.reduce(
                    ...
                    {}),
                n = Object.keys(e).map(function(r) { return m(e[r], r) }),
