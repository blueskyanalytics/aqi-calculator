parcelRequire =
    ...
    function(require, module, exports) {
      ...
      !function(e, r) {
        "object" ==
                ...
                typeof module
            ? module.exports = r()
            : "function" == typeof t && t.amd ? t(r) : e.dayjs = r()
      }(this, function() {
        "use strict";
        var t = "millisecond", n = "second", e = "minute", r = "hour",
            ...
            l = "en", y = {};
        y[l] = $;
        var m = function(t) { return t instanceof D }, M = function(t, n, e) {
          var r;
          if (!t)
            return l;
          if ("string" == typeof t)
          ...
          return d.parse =
            ...
            this.$d = function(t) {
              ...
              return new Date(n)
                 ...
                 d.$g = function(
                     t, n, e) { return p.u(t) ? this[n] : this.set(e, t) },
                 ...
                 d.startOf =
                     function(t, o) {
                   var f = this, h = !!p.u(o) || o, c = p.p(t),
                       d =
                           function(t, n) {
                         var e = p.w(f.$u ? Date.UTC(f.$y, n, t)
                                          : new Date(f.$y, n, t),
                                     f);
                       ...
                       $ =
                           function(t, n) {
                         return p.w(f.toDate()[t].apply(
                                        f.toDate("s"), (h ? [ 0, 0, 0, 0 ]
                                                          : [ 23, 59, 59, 999 ])
                                                           .slice(n)),
                                    f)
                       },
                       l = this.$W, y = this.$M, m = this.$D,
                       M = "set" + (this.$u ? "UTC" : "");
                   switch (c) {
                   case a:
                 ...
                 d.$set =
                     function(s, o) {
                   var f, h = p.p(s), c = "set" + (this.$u ? "UTC" : ""),
                          d = (f = {}, f[i] = c + "Date", f.date = c + "Date",
                               f[u] = c + "Month", f[a] = c + "FullYear",
                               f[r] = c + "Hours", f[e] = c + "Minutes",
                               f[n] = c + "Seconds", f[t] = c + "Milliseconds",
                               f)[h],
                          $ = h === i ? this.$D + (o - this.$W) : o;
                   if (h === u || h === a) {
                 ...
                 d.get = function(t) { return this[p.p(t)]() },
                 d.add =
                     function(t, o) {
                   var f, h = this;
                   t = Number(t);
                   var c = p.p(o), d = function(n) {
                     var e = g(h);
                     return p.w(e.date(e.date() + Math.round(n * t)), h)
                   };
                   if (c === u)
                   ...
                   if (c === s)
                     return d(7);
                   var $ = (f = {}, f[e] = 6e4, f[r] = 36e5, f[n] = 1e3,
                            f)[c] ||
                           1,
                       l = this.$d.getTime() + t * $;
                   return p.w(l, this)
                 ...
                 d.format =
                   ...
                   if (!this.isValid())
                     return "Invalid Date";
                   var e = t || "YYYY-MM-DDTHH:mm:ssZ", r = p.z(this),
                       i = this.$locale(), s = this.$H, u = this.$m,
                       o = this.$M, a = i.weekdays, f = i.months,
                       c =
                           function(t, r, i, s) {
                         return t && (t[r] || t(n, e)) || i[r].substr(0, s)
                       },
                       d = function(t) { return p.s(s % 12 || 12, t, "0") },
                 ...
                 d.diff =
                   ...
                   var c, d = p.p(f), $ = g(t),
                          ...
                          y = this - $, m = p.m(this, $);
                   return m = (c = {}, c[a] = m / 12, c[u] = m, c[o] = m / 3,
                               c[s] = (y - l) / 6048e5, c[i] = (y - l) / 864e5,
                               c[r] = y / 36e5, c[e] = y / 6e4, c[n] = y / 1e3,
                               c)[d] ||
                              y,
                          h ? m : p.a(m)
                 },
                 d.daysInMonth = function() { return this.endOf(u).$D },
                 d.$locale = function() { return y[this.$L] },
                 d.locale =
                     function(t, n) {
                   if (!t)
                     return this.$L;
                 ...
                 d.clone = function() { return p.w(this.$d, this) },
        ...
        return g.prototype = D.prototype,
               g.extend = function(t, n) { return t(n, D, g), g }, g.locale = M,
               g.isDayjs = m, g.unix = function(t) { return g(1e3 * t) },
               g.en = y[l], g.Ls = y, g
      });
    },
    {}
  ...
  "QCct" : [
    function(require, module, exports) {
      function r(r) { return e(r) || n(r) || o(r) || t() }
      function t() {
        throw new TypeError(
      ...
      function a(r, t) { return f(r) || l(r, t) || o(r, t) || i() }
      function i() {
        throw new TypeError(
      ...
      function l(r, t) {
        if ("undefined" != typeof Symbol && Symbol.iterator in Object(r)) {
          var n = [], e = !0, a = !1, i = void 0;
          try {
            for (var o, u = r[Symbol.iterator]();
                 !(e = (o = u.next()).done) &&
      ...
      var c = require("./dayjs.min"), y = require("./utils"), d = y.BANDS,
          m = y.HOUR_DIFF, s = function() {
            var r = arguments.length > 0 && void 0 !== arguments[0]
                        ? arguments[0]
                        : [],
                t = arguments.length > 1 ? arguments[1] : void 0;
            if (!Object.keys(m).includes(t))
              return null;
            var n = c(), e = m[t], i = r.filter(function(r) {
              var t = r.datetime;
              return r.value && n.diff(c(t), "hours") < e
            });
            if (i.length <= 0)
              return null;
            var o = i.reduce(function(r, t) { return r + t.value }, 0) /
                    i.length,
                u = d.findIndex(function(r) { return r.range[t][1] >= o });
            if (u < 0) {
              var l = d.length - 1, f = d[l].range.aqi[1], y = d[l].range[t][1];
              return f / y * (o - y) + f
            }
            var s = a(d[u].range.aqi, 2), v = s[0], h = s[1],
                b = a(d[u].range[t], 2), g = b[0];
            return (h - v) / (b[1] - g) * (o - g) + v
          }, v = function(t) {
            ...
            var n = t.reduce(
                    function(t, n) {
                      return Object.keys(m).map(function(e) {
                        var a = {datetime : n.datetime, value : n[e]};
                        t[e] = t[e] ? [].concat(r(t[e]), [ a ]) : [ a ]
                      }),
                             t
                    },
                    {}),
                e = Object.keys(n)
                        .map(function(r) { return s(n[r], r) })
                        .filter(function(r) { return r });
            if (0 === e.length)
              return null;
            var a = Math.max.apply(Math, r(e));
            return Math.round(a)
          };
      module.exports = v;
    },
